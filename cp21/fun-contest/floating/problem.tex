...
\begin{tabular}{cc}
  \includegraphics[width=0.5\textwidth]{.template/floating.png}
    & \includegraphics[width=0.5\textwidth]{.template/grid.png} \\
  \includegraphics[width=0.5\textwidth]{.template/crossing.png}
    & \includegraphics[width=0.35\textwidth]{.template/rip.png} \\
\end{tabular}
